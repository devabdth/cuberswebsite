...
const initializeSidePanel= (projectData)=> {
	...
	document.getElementById('client-logo').style.background= `url(/images/icons/${projectData['id']})`;
	document.getElementById('client-logo').style.backgroundSize= `contain`;
...
const displayPartInInformationSection= (milestoneTitle, partData)=> {
	...
	for (let resultPart of partData['results']) {
		...
		if(resultPart['asset'] != undefined) {
			...
			asset.style.backgroundImage= `url(/images/assets/${resultPart['asset']}`;
...
const openMilestonesDrawer= ()=> {
	document.querySelector('section#main > div#side-panel').style.left= '0';
	document.getElementById('popup-overlay').style.display= 'flex';
}

const openInformationPanel= ()=> {
	document.getElementById('information-panel').style.display= 'flex';
	document.getElementById('information-panel').style.top= '5%';
	document.getElementById('popup-overlay').style.display= 'flex';

}

const closeAllPopOverlay= ()=> {
	document.querySelector('section#main > div#side-panel').style.left= '-41%';
	document.getElementById('information-panel').style.top= '-100%';
